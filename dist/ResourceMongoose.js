...
var ResourceMongoose = function ResourceMongoose() {
...
Object.assign(ResourceMongoose.Private.prototype, {
    ...
    get: function get(query) {
        ...
        return self.activeRequests[requestId] = Promise.resolve().then(function () {
            var resources = null;
            var dbQuery = null;
            var pageNumber = 1;
            ...
            if (resources) {
                ...
                return self.config.Model.find(dbQuery, '-__v').sort(sort).skip(startIndex).limit(entriesPerPage).populate(self.config.populate).then(function (documents) {
    ...
    constructMongoQuery: function constructMongoQuery(query) {
        var dbQuery = {};
        var key = '';
        var value = null;
    ...
    stripMongoCruft: function stripMongoCruft(mongoObject) {
        var self = this,
            key = null,
            prop = null;
    ...
    create: function create(payload) {
        ...
        return resource.save().then(function (document) {
    ...
    update: function update(query, payload, options) {
        var self = this,
            dbQuery = null;
    ...
    delete: function _delete(query, options) {
        var self = this;
        var dbQuery = null;
        var document = null;
        ...
        return self.config.Model.findOne(dbQuery, '-__v').then(function (_document) {
            document = _document;
